...
samples/BlazorVirtualize.Sample        Runnable demos (fixed, dynamic, provider, horizontal)
tests/BlazorVirtualize.Tests           Unit tests for the core algorithm
```
...
dotnet build
dotnet test
dotnet run --project samples/BlazorVirtualize.Sample
```
